...
# gasoperationsroutesheetagent.py - Handles gas operations routesheet-related queries by generating and executing SQL

import json
from datetime import datetime
from zoneinfo import ZoneInfo
from config.azure_client import get_azure_chat_openai
from prompts.gasoperationsroutesheetprompt import get_gasoperationsroutesheet_sql_prompt  
...
async def handle_gasoperationsroutesheet(query: str, auth_token: str = None):
    """
    ...
    try:
        ...
        system_prompt = get_gasoperationsroutesheet_sql_prompt(query, current_year, examples_context)
